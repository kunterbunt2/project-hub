...
import de.bushnaq.abdalla.projecthub.util.AvailabilityViewTester;
 ...
 * <p>
 * The tests use {@link AvailabilityViewTester} to interact with the UI elements
...
public class AvailabilityListViewTest extends AbstractUiTestUtil {
    ...
    @Autowired
    private AvailabilityViewTester availabilityViewTester;
    ...
    public void setupTest(TestInfo testInfo) {
        availabilityViewTester.switchToAvailabilityListView(
    ...
    public void testCannotDeleteOnlyAvailability() {
        ...
        availabilityViewTester.verifyCannotDeleteOnlyAvailability(initialDate);
    }
    ...
    public void testCreateCancel() {
        availabilityViewTester.createAvailabilityCancel(startDate, availabilityPercent);
    }
    ...
    public void testCreateConfirm() {
        availabilityViewTester.createAvailabilityConfirm(startDate, availabilityPercent);
    }
    ...
    public void testDeleteCancel() {
        ...
        availabilityViewTester.deleteAvailabilityCancel(startDate);
    }
    ...
    public void testDeleteConfirm() {
        ...
        availabilityViewTester.deleteAvailabilityConfirm(startDate);
    }
    ...
    public void testDuplicateStartDate() {
        ...
        availabilityViewTester.createDuplicateDateAvailability(initialDate, newAvailabilityPercent);
    }
    ...
    public void testEditCancel() {
        ...
        availabilityViewTester.editAvailabilityCancel(initialDate, newStartDate, initialPercent, newAvailabilityPercent);
    }
    ...
    public void testEditConfirm() {
        ...
        availabilityViewTester.editAvailabilityConfirm(initialDate, newStartDate, newAvailabilityPercent);
    }
    ...
    public void testInvalidPercentage() {
        ...
        availabilityViewTester.createInvalidPercentageAvailability(startDate, invalidHighPercent);

        // Try to create record with negative percentage
        availabilityViewTester.createInvalidPercentageAvailability(newStartDate, invalidLowPercent);
    }
}
