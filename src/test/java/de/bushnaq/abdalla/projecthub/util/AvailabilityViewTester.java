...
import de.bushnaq.abdalla.projecthub.ui.AvailabilityListView;
import de.bushnaq.abdalla.projecthub.ui.LoginView;
import de.bushnaq.abdalla.projecthub.ui.ProductListView;
import de.bushnaq.abdalla.projecthub.ui.common.AvailabilityDialog;
...
@Component
@Lazy
public class AvailabilityViewTester {
     ...
     */
    public AvailabilityViewTester(SeleniumHandler seleniumHandler, @Value("${local.server.port:8080}") int port) {
