...
import de.bushnaq.abdalla.projecthub.ui.LocationListView;
...
import de.bushnaq.abdalla.projecthub.ui.common.LocationDialog;
...
@Component
@Lazy
public class LocationViewTester {
     ...
     */
    public LocationViewTester(SeleniumHandler seleniumHandler, @Value("${local.server.port:8080}") int port) {
