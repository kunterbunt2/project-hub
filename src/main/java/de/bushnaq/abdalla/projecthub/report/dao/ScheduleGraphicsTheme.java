...
public class ScheduleGraphicsTheme extends GraphicsTheme {
    ...
    public                 Color   ganntMonthTextColor;
    public                 Color   ganttCriticalRelationColor;
    public                 Color   ganttCriticalTaskBorderColor;
    public                 Color   ganttDayBorderColor;
    public                 Color   ganttDayOfMonthBorderColor;
    ...
    public                 Color   ganttMondayColor;
    public                 Color   ganttMonthBorderColor;
    ...
    public                 Color   ganttSundayStripeColor;
    public                 Color   ganttTaskBorderColor;
    public                 Color   ganttTaskTextColor;
    public                 Color   ganttWeekBoderColor;
