...
//        calendarYearBoderColor = basicBorderColor;
        ...
        //        for (int iteraton = 0; iteraton < alpha.length; iteraton++) {
        //            //ff0000
        //            ps = 0xff;//primary color
        //            pg = 0xcf;//primary color green
        //            ss = 0x00;//secondary color
        //            sg = 0x00;//secondary color green
        //            ts = 0x00;//trinary color
        //            tg = 0x00;//trinary color green
        //            int a = alpha[iteraton];
        //            i = generateColors(ps, pg, ss, sg, ts, tg, i, a);
        //
        //            //ffff00
        //            ps = 0xff;//primary color
        //            pg = 0xcf;//primary color green
        //            ss = 0xff;//secondary color
        //            sg = 0xcf;//secondary color green
        //            ts = 0x00;//trinary color
        //            tg = 0x00;//trinary color green
        //            i = generateColors(ps, pg, ss, sg, ts, tg, i, a);
        //
        ...
        //            ss = 0xff;//secondary color
        //            sg = 0xcf;//secondary color green
        //            ts = 0x8f;//trinary color
        //            tg = 0x8f;//trinary color green
        //            i = generateColors(ps, pg, ss, sg, ts, tg, i, a);
        //
        //            //ff8f00
        //            //            ps = 0xff;//primary color
